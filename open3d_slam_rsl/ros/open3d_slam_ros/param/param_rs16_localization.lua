...
--Advanced Options.
params.odometry.use_odometry_topic_instead_of_scan_to_scan = false --Uses External Odometry topic instead of Scan2Scan registration.
...
params.mapper_localizer.scan_to_map_registration.icp.reference_cloud_seting_period = 0.1 --Seconds
